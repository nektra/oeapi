/* $Id: atl_addin.h,v 1.3 2008/09/07 16:57:08 ibejarano Exp $
 *
...
// ISupportsErrorInfo
	...
	BEGIN_SINK_MAP(Catl_addin)
		...
		SINK_ENTRY_INFO(2, __uuidof(OEAPI::IOEAPIObjEvents), 0x000d, OnDatabaseChange, &FourLongParamInfo)
	...
	//------------------------------------------------------------------//
	STDMETHOD(OnDatabaseChange)(long tr, long folderId, long messageId, long other);
